...
public final class HttpUtil {
	 ...
	 * 下载图片
	 * 
	 * @param urlList       链接url下载图片
	 * @param imageNameFile 文件存储路径
	 * @return
	 */
	public static boolean downloadPicture(String urlList, String imageNameFile) {
		URL url = null;
		int imageNumber = 0;
		...
		try {
			...
			FileOutputStream fileOutputStream = new FileOutputStream(new File(imageNameFile));
