    ...
    var tableIns = table.render({
        ...
        cols : [[
            {type: "checkbox", fixed:"left", width:50}
		 	 ...
		 	 ,{field: 'account', title: '飞码用户Id', minWidth:100, align:"center"}
		 	 ,{field: 'userId', title: 'app用户id', minWidth:100, align:"center"}
        ]] 
    });
