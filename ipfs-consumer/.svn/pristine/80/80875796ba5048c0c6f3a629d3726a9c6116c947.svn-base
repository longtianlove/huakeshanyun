    ...
    var tableIns = table.render({
        ...
        cols : [[
            {type: "checkbox", fixed:"left", width:50}
		 	 ...
		 	 ,{field: 'logData', title: '返回日志', minWidth:100, align:"center"}
		 	 ,{field: 'userId', title: '用户信息', minWidth:100, align:"center"}
        ...
        layui.layer.open({ 
            ...
            success : function(layero, index){
                ...
                if(edit){
                    	   ...
                    	   body.find(".logData").val(edit.logData); 
