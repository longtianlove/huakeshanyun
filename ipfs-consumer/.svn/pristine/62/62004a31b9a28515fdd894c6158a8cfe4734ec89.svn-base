...
public class GlobalExceptionHandler {
	...
	@ResponseBody
	public ResultInfo<Boolean> handleHttpMediaTypeNotSupportedException(HttpMediaTypeNotSupportedException e) {
	...
	@ResponseBody
	public ResultInfo<Boolean> TokenException(TokenException e) {
		logger.error("没有token！", e);
		return new ResultInfo<>("-4", "没有权限！");
	}
	...
	public ResultInfo<Boolean> handleException(Exception e) {
        ...
        e.printStackTrace();
		return new ResultInfo<>("500", "网络不稳定，请稍后再试！");
    }
