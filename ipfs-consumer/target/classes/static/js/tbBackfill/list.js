    ...
    var tableIns = table.render({
        ...
        cols : [[
            {type: "checkbox", fixed:"left", width:50}
		 	 ...
		 	 ,{field: 'backfillValue', title: '回填值', minWidth:100, align:"center"}
		 	 ,{field: 'backfillTime', title: '回填结束时间', minWidth:100, align:"center"}
		 	 ,{field: 'createTime', title: '创建时间', minWidth:100, align:"center"}
		 	 ,{field: 'userId', title: '用户编号', minWidth:100, align:"center"}
		 	 ,{field: 'status', title: '回填状态', minWidth:100, align:"center"}
        ]] 
    });
        ...
        layui.layer.open({ 
            ...
            success : function(layero, index){
                ...
                if(edit){
                    	   ...
                    	   body.find(".backfillValue").val(edit.backfillValue); 
                    	   body.find(".backfillTime").val(edit.backfillTime); 
