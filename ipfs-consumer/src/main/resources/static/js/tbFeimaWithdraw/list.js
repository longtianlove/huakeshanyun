    ...
    var tableIns = table.render({
        ...
        cols : [[
            {type: "checkbox", fixed:"left", width:50}
		 	 ...
		 	 ,{field: 'handlerFee', title: '转出手续费', minWidth:100, align:"center"}
        ]] 
    });
            ...
            success : function(layero, index){
                ...
                if(edit){
                    	  body.find("#id").val(edit.id); 
                    	   ...
                    	   body.find(".handlerFee").val(edit.handlerFee); 
                    form.render(); 
                }
                setTimeout(function(){
