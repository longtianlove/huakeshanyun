    ...
    var tableIns = table.render({
        ...
        cols : [[
            {type: "checkbox", fixed:"left", width:50}
		 	 ...
		 	 ,{field: 'contractAddress', title: '合同地址', minWidth:100, align:"center"}
            ...
            success : function(layero, index){
                ...
                if(edit){
                    	  body.find("#id").val(edit.id); 
                    	   ...
                    	   body.find(".contractAddress").val(edit.contractAddress); 
