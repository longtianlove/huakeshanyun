...
public class OmniTransaction extends Transaction {
	...
	public OmniTransaction(Transaction transaction) {
		super(transaction.getParams(), transaction.bitcoinSerialize()); // Is serialized byte array == payload byte
																		// array???
	...
	/* Create Signed */
	public OmniTransaction(ECKey fromKey, List<TransactionOutput> unspentOutputs, Address refAddress, byte[] payload)
