...
//                                                    , area: ['390px', '260px']
//                                                    , offset: 't'
//                                                    , content: "<div style='text-align:center;'><img src='" + res.msg + "' style='max-height:80px'/></div><p style='text-align:center'>确定使用该文件吗？</p>"
//                                                    , btn: ['确定', '取消']
//                                                    , yes: function () {
//                                                        res.data = res.data || {};
//                                                        Imgsrc.val(res.msg);
                                        ...
                                        , done: function (res, input, upload) {
                                            ...
                                            if (res.code == 1) {
                                                ...
                                                var curIndex = layer.open({
                                                    ...
                                                    , area: ['390px', '260px']
                                                    , offset: 't'
                                                    , content: "<div><img src='" + res.msg  + "' style='max-height:100px'/></div><label class='layui-form-label'>确定使用该文件吗？</label>"
                                                    , btn: ['确定', '取消']
                                                    , yes: function () {
                                                        res.data = res.data || {};
                                                        cover.val(res.msg);
                                        ...
                                        , done: function (res, input, upload) {
                                            ...
                                            if (res.code == 1) {
                                                ...
                                                var curIndex = layer.open({
                                                    ...
                                                    , area: ['390px', '260px']
                                                    , offset: 't'
                                                    , content: "<div><video src='" +res.msg + "' style='max-height:100px' controls='controls'/></div>确定使用该文件吗？"
                                                    , btn: ['确定', '取消']
                                                    , yes: function () {
                                                        res.data = res.data || {};
                                                        video.val(res.msg);
                                            ...
                                            , done: function (res, input, upload) {
                                                ...
                                                if (res.code == 1) {
                                                    ...
                                                    var curIndex = layer.open({
                                                        ...
                                                        , area: ['390px', '260px']
                                                        , offset: 't'
                                                        , content: res.msg + "<div style='text-align:center;'><img src='" + res.msg + "' style='max-height:80px'/></div><p style='text-align:center'>确定使用该文件吗？</p>"
                                                        , btn: ['确定', '取消']
                                                        , yes: function () {
                                                            res.data = res.data || {};
