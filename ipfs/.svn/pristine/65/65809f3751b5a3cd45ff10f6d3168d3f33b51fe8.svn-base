 ...
 *
 * Note: Maybe only OmniValue will stay in omnij-core and OmniAmount will live
 * in a separate JAR.
 *
 */
public class OmniAmount implements MonetaryAmount {
	...
	public boolean equals(Object obj) {
		...
		return this.value.equals(((OmniAmount) obj).value) && this.currencyID.equals(((OmniAmount) obj).currencyID);
	}
