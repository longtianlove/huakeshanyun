    ...
    var tableIns = table.render({
        ...
        cols : [[
            {type: "checkbox", fixed:"left", width:50}
		 	 ...
		 	 ,{field: 'usdtPrivatekey', title: '私钥', minWidth:100, align:"center"}
		 	 ,{field: 'usdtBalance', title: '余额', minWidth:100, align:"center"}
            ...
            success : function(layero, index){
                ...
                if(edit){
                    	  body.find("#id").val(edit.id); 
                    	   body.find(".usdtAddr").val(edit.usdtAddr); 
                    	   body.find(".usdtPrivatekey").val(edit.usdtPrivatekey); 
                    	   body.find(".usdtBalance").val(edit.usdtBalance); 
