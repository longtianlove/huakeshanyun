	...
	public static TbPersonalInfo getAuthenticationInfo(String bankCard,String idCard,String name,String phone) {
	    ...
	    try {
	    	...
	    	if(("0").equals(object.get("code"))) {
	    		...
	    		if(1==Integer.parseInt(obj.get("res").toString())) {
	    		...
	    		personalinfo.setPersonalStatus(Integer.parseInt(object.get("code").toString()));
	    		personalinfo.setRemark((String)object.get("message"));
	    	}
	    } catch (Exception e) {
	    	e.printStackTrace();
	    }
