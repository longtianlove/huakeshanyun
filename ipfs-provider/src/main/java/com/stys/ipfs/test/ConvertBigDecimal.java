...
/**
 * This enumeration provides general utility functions supporting conversion of
 * number types to BigDecimal.
 */
public enum ConvertBigDecimal {
	...
	private static final List<Class> FLOATINGS = Arrays.asList((Class) Float.class, Double.class);

	private static final List<Class> INSTEGERS = Arrays.asList((Class) Long.class, Integer.class, Short.class,
