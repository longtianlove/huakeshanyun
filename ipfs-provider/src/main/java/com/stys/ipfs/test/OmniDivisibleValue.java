...
/**
 * Numeric Value of Divisible Omni Token An Omni Divisible token is typically
 * represented to the user as a decimal amount and hence you can have a
 * fractional number of tokens. Internally it uses the same format as a
 * divisible token.
 *
 */
