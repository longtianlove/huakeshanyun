...
public class CnNumberUtils {
    ...
    public static void main(String[] a) {
        System.out.println(toUppercase(1230008.51));
    }
    ...
    public static String toUppercase(Double num) {
        return toUppercase(convertNumber(num));
    }
     ...
     * @return
     */
    public static String getSingleUp(int x) {
        return CN_NUMERALS[x] ;
    }
}