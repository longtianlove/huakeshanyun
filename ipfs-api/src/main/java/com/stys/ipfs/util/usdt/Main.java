...
public class Main {
	...
	public static void main(String[] args) throws Throwable {
		...
		try {
			...
			/*
			 * String result1 =
			 * CoinUtils.getInstance().send("1cwiGA6TYp97p1ska3QS9yjZZ5yfkgZ5c",
			 * "3EGckcPGey8qyB6o5bGbkFdYreecpfRhNm", 31, 2.11,
			 * "1C1BtSbD8RZfY1Neg6UJ3mvVPSoH55kGcU"); System.out.println(result1);
